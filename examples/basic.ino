...
ConfigGroup config_group_base;
ConfigGroup config_group_network;
...
void setup() {
    ...
    config_group_base.setup("base");
    config_group_network.setup("network");
    ...
    config_group_base.add_child(&ci_bool);
    config_group_base.add_child(&ci_int);
    config_group_base.add_child(&ci_float);
    config_group_base.add_child(&ci_string);
    config_group_network.add_child(&ci_ip);
    config_manager.add_group(&config_group_base);
    config_manager.add_group(&config_group_network);
